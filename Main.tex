...
\begin{document}
    \include{Src/Naslovna}
    \include{Src/Upozorenje}
    ...
    \begin{framebg}{Ponizni vektori}{Res/img/fibonacci}{0.4}
        \pause
        \begin{df}[Fibonačijevi nizovi]
            Nizovi gde je svaki sledeći član
    ...
    \begin{framebg}{Svadba}{Res/img/wedding}{0.5}
        ...
        \end{itemize}
    \end{framebg}
    \framecard{\Huge{Hvala na pažnji!} \\ \large{\LaTeX\  btw}}
\end{document}
